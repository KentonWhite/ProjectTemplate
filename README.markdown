# ProjectTemplate [![Travis-CI build status](https://travis-ci.org/johnmyleswhite/ProjectTemplate.png?branch=master)](https://travis-ci.org/johnmyleswhite/ProjectTemplate) [![AppVeyor build status](https://ci.appveyor.com/api/projects/status/u4it44b78py4ofr9/branch/master)](https://ci.appveyor.com/project/johnmyleswhite/projecttemplate/branch/master)
