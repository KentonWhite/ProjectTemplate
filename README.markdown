# ProjectTemplate [![Travis-CI build status](https://travis-ci.org/tomschloss/ProjectTemplate.png?branch=master)](https://travis-ci.org/tomschloss/ProjectTemplate)
