# ProjectTemplate [![Travis-CI build status](https://travis-ci.com/KentonWhite/ProjectTemplate.png?branch=master)](https://travis-ci.com/KentonWhite/ProjectTemplate)
